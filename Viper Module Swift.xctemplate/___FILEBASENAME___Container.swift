...
class ___FILEBASENAMEASIDENTIFIER___Container: AssemblyType {
    ...
    func assemble(container: Container) {
        ...
        container.register(___FILEBASENAMEASIDENTIFIER___InterfaceProtocol.self) {  (r, parentRouter: ___FILEBASENAMEASIDENTIFIER___ParentRouterProtocol) in
            let controller = SwinjectStoryboard.create(name: "___FILEBASENAMEASIDENTIFIER___", bundle: nil).instantiateInitialViewController() as! ___FILEBASENAMEASIDENTIFIER___InterfaceProtocol
            let presenter = r.resolve(___FILEBASENAMEASIDENTIFIER___PresenterProtocol.self, arguments: (controller, parentRouter))!
